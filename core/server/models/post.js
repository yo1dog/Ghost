...
var _              = require('lodash'),
    ...
    prismsyntaxhighlighter = require('../../shared/lib/showdown/extensions/prismsyntaxhighlighter'),
    githubinlinecode = require('../../shared/lib/showdown/extensions/githubinlinecode'),
    converter      = new Showdown.converter({extensions: [ghostgfm, prismsyntaxhighlighter, githubinlinecode]}),
    Tag            = require('./tag').Tag,
